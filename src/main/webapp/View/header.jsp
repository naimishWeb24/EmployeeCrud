	...
	<a class="navbar-brand text-white" href="#"><img src="https://webosmotic.com/wp-content/themes/icw-webosmotic/assets/images/logo.svg " alt="Logo" style="width:190px;" class="rounded-pill"></a>
    	...
    	<div class="collapse navbar-collapse" id="navbarSupportedContent">
	      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
	        <li class="nav-item">
	          <a class="nav-link active text-dark"  aria-current="page" href="/EmployeeCrud/View/insert.jsp">Home</a>
	        </li>
	        <li class="nav-item">
	          <a class="nav-link text-dark" href="/EmployeeCrud/EmployeeServlet">display</a>
	        </li>
      	</ul>
    </div>
  </div>
